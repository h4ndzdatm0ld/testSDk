...
__all__ = ["BgpIpv6SrPolicyNlriPrefixParam"]


class BgpIpv6SrPolicyNlriPrefixParam(TypedDict, total=False):
    color: int
    ...
    The Endpoint may represent a single node or a set of nodes (e.g., an anycast
    address). The Endpoint is an IPv6 address and can be either a unicast or an
    unspecified address (0::0) as specified in section 2.1 of RFC9256.
    """
