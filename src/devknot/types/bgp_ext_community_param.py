...
__all__ = ["BgpExtCommunityParam"]


class BgpExtCommunityParam(TypedDict, total=False):
    subtype: Literal["route_target", "origin", "extended_bandwidth", "color", "encapsulation", "mac_address"]
